...
import { discoverUsers, getMyProfile, getQuestionOptions, likeUser, skipUser, submitQuestions, updateMyProfile, uploadProfilePhotos, removeProfilePhoto } from '../controllers/userController.js';
...
router.delete('/me/photos', auth, removeProfilePhoto);
